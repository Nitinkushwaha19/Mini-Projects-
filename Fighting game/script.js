...
console.log(p2NameDiv.innerText)
...
class Player {
    ...
    strike(player, enemy, attackDmg) {
        ...
        // console.log(`${player.name} strikes 👊 ${enemy.name} for ${damageAmount} damage!`)
        //  Return a message of 'player name attacks enemy name for damageAmount'
        return `${player.name} strikes 👊 ${enemy.name} for ${damageAmount} damage!`
    }
...
let player1 = new Player('NITIN', 100, 5)
let player2 = new Player('MANOHAR', 100, 5)
...
let p1AttackButton = getElementById('attack')
p1AttackButton.onclick = () => p1.strike(p1, p2, p1.attackDmg)
